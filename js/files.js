...
(function (factory) {
    ...
    $.extend($.summernote.plugins, {
		...
		'seccion': function(context) {
			var ui= $.summernote.ui;
			context.memo('button.seccion',function(){
				var button=ui.button({
					contents: '<i class="glyphicon glyphicon-glass"/>',
					tooltip: 'Insert full section',
					click: context.invoke('editor.insertText', 'hello')
				});
				var $seccion = button.render();
				return $seccion;
			});
		}			
    });
